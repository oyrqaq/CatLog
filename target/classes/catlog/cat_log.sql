...
('C0010', 'miumiu', '2024-09-15', 'Male', 'Redpoint', 100, false),
('C0011', 'loki', '2024-10-30', 'Female', 'Tabby', 130, false),
('C0012', 'lux', '2024-11-10', 'Female', 'Tortoiseshell', 160, true),
('C0013', 'lucky', '2024-11-25', 'Male', 'Cream', 145, false),
('C0014', 'mac', '2024-09-30', 'Female', 'Black', 115, true);

-- Insert data into the User table
INSERT INTO User (userID, name, email, phone, role)
VALUES
('0000', 'TestA', 'test@a.com', '555-0100', 'admin'),
...
VALUES
('R0000', 'C0002', '0001', '2024-12-05'),
('R0001', 'C0005', '0002', '2024-12-07'),
('R0002', 'C0008', '0004', '2024-12-11'),
('R0003', 'C0010', '0005', '2024-12-09'),
('R0004', 'C0011', '0007', '2024-12-11'),
('R0005', 'C0013', '0008', '2024-12-08');
